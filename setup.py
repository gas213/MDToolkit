...
setup(
    ...
    description="Internal Tool for MD Simulation Analysis",  # Optional
    ...
    url="https://github.com/gas213/MDToolkit",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Gregory Scott",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="gas213@lehigh.edu",  # Optional
    ...
    project_urls={  # Optional
        "Source": "https://github.com/gas213/MDToolkit",
    },
)