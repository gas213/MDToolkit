...
# Paths to image files (left-to-right, then top-to-bottom)
IMAGES: list[str] = [
    "path/to/example.png"
]
...
MARGIN_LEFT: float = 0.01 # Left margin as a fraction of figure width
MARGIN_RIGHT: float = 0.0 # Right margin as a fraction of figure width
MARGIN_TOP: float = 0.0 # Top margin as a fraction of figure height
MARGIN_BOTTOM: float = 0.0 # Bottom margin as a fraction of figure height
